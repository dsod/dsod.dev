    ...
    <div className="row justify-content-center">
      <div className="col-6 col-md-5 col-lg-4 position-relative">
        ...
        <ul>
          ...
          <p>
            I have found that illustrating solutions, in addition to discussions
            and documentation, is a great tool to make sure all parties are on
            the same page.
          </p>
          <p>
          ...
          <p>
            I have worked close together with a software development team and
            have been responsible for defining and reproducing user stories and
            bugs respectively, with acceptance test cases and reproducible
            steps.
          </p>
          <p>
          ...
          <p>
            While technical forums is where I feel at home, I have grown custom
            to adjusting the level of technical terms in discussions as needed.
          </p>
